...
<div class="col s12 m8">
    ...
    <div style="margin-top: 30px;">
	    ...
	    <f:form modelAttribute="produto" style="float: right; margin-right: 20px" class="form-horizontal" role="form" action="${contextPath}/produto/remover/${produto}" method="POST" >
